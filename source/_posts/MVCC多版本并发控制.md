...
![1.png](/img/MVCC多版本并发控制/数据案例.png)
...
![image-20210225235444975](/img/MVCC多版本并发控制/1.png)
...
![image-20210313220450629](/img/MVCC多版本并发控制/2.png)
...
![image-20210313220337624](/img/MVCC多版本并发控制/3.png)
...
从上述表格中，我们可以看到，当事务2对某行数据执行了快照读，数据库为该行数据生成一个Read
...
![image-20210227183316573](/img/MVCC多版本并发控制/4.png)

在上述的例子中，只有事务4修改过该行记录，并在事务2进行快照读前，就提交了事务，所以该行当前数据的undolog如下所示：

![image-20210227183849998](/img/MVCC多版本并发控制/5.png)
...
![image-20210227185820394](/img/MVCC多版本并发控制/6.png)
